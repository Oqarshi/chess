...
public class Move
{
  ...
  Move(int startRow, int startCol, int endRow, int endCol, int PIECEMOVED, int PIECECAPTURED, boolean ISPAWNPROMOTION, boolean ISCASTLE, boolean ISENPASSANT)
  {
    srow = (byte)startRow;
    scol = (byte)startCol;
    erow = (byte)endRow;
  ...
  public boolean equals(Move move) {
    return (move.getNotation().equals(getNotation()));
  }

  public Move clone() {
    return new Move(srow, scol, erow, ecol, pieceMoved, pieceCaptured, isPawnPromotion, isCastle, isEnPassent);
  }
}
